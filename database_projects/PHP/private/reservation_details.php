            ...
            if(isset($transaction_details)){
                do{ ?>
                    <div class="movie_container" style="background-image:url(<?php echo $transaction_details['image']?>);background-size:100% 100%;background-repeat:no-repeat">
                        <?php
                            echo "<div class=details>".$transaction_details['title']."<br/><br/>price:".$transaction_details['price']."<br/> quantity".$transaction_details['sum']."<br/> Bills: ".($transaction_details['sum']*$transaction_details['price'])."</div>";
